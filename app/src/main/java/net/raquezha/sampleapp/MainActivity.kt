...
class MainActivity : AppCompatActivity() {
    ...
    fun showDialog() {
        ...
        carouselDialog = CarouselDialog.createCarouselDialog(this@MainActivity, dataList) {
            ...
            onItemChangedListener(DiscreteScrollView.OnItemChangedListener { viewHolder, adapterPosition ->
                Toast.makeText(this@MainActivity, "OnItemChanged postion $adapterPosition", Toast.LENGTH_SHORT).show()
            })

            onScrollListener(DiscreteScrollView.ScrollListener { scrollPosition, currentPosition, newPosition, currentHolder, newCurrent ->
